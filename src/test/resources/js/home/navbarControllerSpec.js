describe('navbarController', function () {
    var $scope, stravaProfileResource, authorizationResource, profileDeferred, authorizationDeferred, signoutDeferred, $http, $window;

    beforeEach(module('navbar'));

    beforeEach(inject(function ($rootScope, $q, _$http_, $controller, _stravaProfileResource_, _authorizationResource_) {
        $scope = $rootScope.$new();
        $http = _$http_;
        $window = {location: {}};
        ...
        spyOn(stravaProfileResource, "get").and.returnValue({$promise: profileDeferred.promise});
